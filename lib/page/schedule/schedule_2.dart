...
var off_aray = ['text'];
var off_val = [0];
class Schedule_2 extends StatefulWidget {
  final scaf;
  final connection;

  const Schedule_2({Key key, this.scaf,this.connection}) : super(key: key);
  @override
  _Schedule_2State createState() => _Schedule_2State();
}

class _Schedule_2State extends State<Schedule_2> {
...
widget.scaf.currentState.showSnackBar(new SnackBar(content: new Text("Schedule Off Request Send",textAlign: TextAlign.left,),duration: new Duration(seconds: 2),));
  on_aray.clear();
  val = '';
  send = '';
  t = '';
           ...
           child: new Column(
            children: <Widget>[
              Container(
                color: Colors.pink,
                 child: new ListTile(
                  title: new Text("Schedule Off",style: TextStyle(color: Colors.white),),
                ),
              ),
                new Container(
